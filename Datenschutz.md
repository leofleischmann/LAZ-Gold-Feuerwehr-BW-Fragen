...
<p>Stand: 12. September 2025</p><h2>Inhaltsübersicht</h2> <ul class="index"><li><a class="index-link" href="#m4158">Präambel</a></li><li><a class="index-link" href="#m3">Verantwortlicher</a></li><li><a class="index-link" href="#mOverview">Übersicht der Verarbeitungen</a></li><li><a class="index-link" href="#m2427">Maßgebliche Rechtsgrundlagen</a></li><li><a class="index-link" href="#m27">Sicherheitsmaßnahmen</a></li><li><a class="index-link" href="#m24">Internationale Datentransfers</a></li><li><a class="index-link" href="#m12">Allgemeine Informationen zur Datenspeicherung und Löschung</a></li><li><a class="index-link" href="#m10">Rechte der betroffenen Personen</a></li><li><a class="index-link" href="#mSupabase">Auftragsverarbeitung / Hosting</a></li><li><a class="index-link" href="#mServerLogs">Erhebung von Zugriffsdaten und Logfiles</a></li><li><a class="index-link" href="#m15">Änderung und Aktualisierung</a></li></ul><h2 id="m3">Verantwortlicher</h2><p>Leo Fleischmann,<br>Schlossstr. 5,<br>72160 Horb am Neckar</p>
<p>E-Mail-Adresse: <a href="mailto:leo.fleischmann04@gmail.com">leo.fleischmann04@gmail.com</a></p>
...
<h2 id="mSupabase">Auftragsverarbeitung / Hosting</h2><p>Wir nutzen zur Bereitstellung unserer Applikation und der Speicherung der Backend-Daten (Datenbank, Authentifizierung) die Dienste des Anbieters <strong>Supabase</strong> (Supabase, Inc., 972 Mission St, San Francisco, CA 94103, USA).</p>
<p>Die Verarbeitung Ihrer personenbezogenen Daten durch Supabase erfolgt im Rahmen einer <strong>Auftragsverarbeitung gemäß Art. 28 DSGVO</strong>. Wir haben hierzu mit Supabase einen sogenannten Data Processing Agreement (DPA / AVV) abgeschlossen. Dieser Vertrag stellt sicher, dass Supabase die Daten unserer Nutzer nur im Rahmen unserer Weisungen und unter Einhaltung der strengen europäischen Datenschutzstandards verarbeitet und sie nicht an unbefugte Dritte weitergibt.</p>
<p><strong>Serverstandort:</strong> Um ein Höchstmaß an Datenschutz zu gewährleisten, haben wir unser Supabase-Projekt so konfiguriert, dass alle Server und Datenbanken ausschließlich auf Servern innerhalb der <strong>Europäischen Union (Region: Frankfurt, Deutschland)</strong> gehostet werden. Es erfolgt somit prinzipiell kein Transfer der produktiven Datenbankinhalte in Staaten außerhalb des Europäischen Wirtschaftsraums (EWR).</p>
<h2 id="mServerLogs">Erhebung von Zugriffsdaten und Server-Logfiles (Telemetrie)</h2><p>Unser Hosting-Dienstleister Supabase erhebt und speichert automatisch technische Metadaten in so genannten Server-Logfiles, um die Stabilität und Sicherheit der API und Datenbank ("API Gateway") zu gewährleisten und Ausfälle oder Angriffe (wie z. B. DDoS-Attacken) zu erkennen.</p>
<p>Zu diesen Daten gehören unter anderem: die aufgerufene API-Route ("Request"), der Typ der Anfrage (z. B. GET, POST), Datum und Uhrzeit der Anfrage, der verwendete User-Agent (Betriebssystem/App-Version), etwaige Fehlermeldungen ("Response Errors") sowie das abgeleitete, ungefähre Herkunftsland (Geography) anhand der anfragenden IP-Adresse.</p>
<p>Eine Zusammenführung dieser isolierten Diagnose-Daten mit bestimmten Nutzerprofilen aus der Datenbank findet nicht statt. Die IP-Adressen werden lediglich zur Bereitstellung der Geostandort-Telemetrie und Sicherheitsüberprüfung kurzzeitig verarbeitet. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 lit. f DSGVO. Unser legitimes Interesse besteht in der Bereitstellung, Optimierung und Absicherung der technischen Infrastruktur unserer App.</p>
